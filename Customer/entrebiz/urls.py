...
urlpatterns = [
                  ...
                  path('apps/download/qr', acc_views.QRCode.as_view()),
                  ...
                  path('domestic-transfer/', tr_views.DomesticTransfer.as_view(),name='domestic-transfer'),
                  path('domestic-transfer-confirm/<str:token>', tr_views.DomesticTransferConfirm.as_view(),
                                           name='domestic-transfer-confirm'),
                  path('getdombeneficiarylist', tr_views.getdombeneficiarylist),
                  path('cancel-domestic-transfer', tr_views.CancelDomesticTransfer.as_view(), name='cancel-domestic-transfer'),
                  path('domestic-transfer/domesticOtp/<str:token>', tr_views.DomesticTransferOtp.as_view(),
                           name='domestic-transfer-domesticOtp'),
                  path('domestic-transfer/success/<str:token>', tr_views.DomesticTransferSuccess.as_view(),
                       name='domestic-transfer-success'),
                  ...
                  # Transaction : UPI Payment
                    path('upipayment', tr_views.UPIpaymentView.as_view()),
                  ...
                  path('settings/api',usr_views.ExternalApiView.as_view()),
               ...
               #    forgot password
                  ...
                  path('referrals', usr_views.Referrals.as_view()),
                  path('referFriend', usr_views.ReferFriend.as_view()),
                  path('refer/<str:code>', usr_views.CheckReferCode.as_view()),

                  #wallet transfer
                  path('walletwithdrawal',tr_views.WalletWithdrawalView.as_view(),name='walletwithdrawal'),
                  path('wallet-withdrawal-confirm/<str:token>', tr_views.WalletWithdrawalConfirm.as_view(),
                       name='wallet-withdrawal-confirm'),
                  path('cancel-wallet-transfer', tr_views.CancelWalletTransfer.as_view(), name='cancel-wallet-transfer'),
                  path('walletwithdrawal-transfer/walletOtp/<str:token>', tr_views.WalletTransferOtp.as_view(),
                       name='wallet-transfer-walletOtp'),
                  path('walletwithdrawal-transfer/success/<str:token>', tr_views.WalletTransferSuccess.as_view(),
                       name='walletwithdrawal-transfer-success'),
                  path('getcryptobeneficiarylist', tr_views.getcryptobeneficiarylist),
