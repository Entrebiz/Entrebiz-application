...
from Transactions.mixins import OTP, FindAccount, TransactionMail, ModelQueries, add_log_action, checkNonAsciiChracters
...
class InternationalWireTransfer(View):
    ...
    def post(self,request):
        ...
        is_ext_ben = Externalbeneficiaries.objects.filter(accountnumber=request.POST.get('BeneficiaryACNo'),isdeleted=False,createdby=request.user).exists()
