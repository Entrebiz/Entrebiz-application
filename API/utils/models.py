...
class Customers(models.Model):
    ...
    outgoingwallettansactionfee = models.DecimalField(max_digits=9, decimal_places=2, default=0)
...
class Useraccounts(models.Model):
    ...
    customer = models.ForeignKey(Customers, related_name='useracc_customer',on_delete=models.CASCADE)  # Field name made lowercase.
    ...
    createdby = models.ForeignKey(Customers, related_name='useracc_created_by', on_delete=models.SET_NULL, blank=True,null=True)  # Field name made lowercase.
    createdon = models.DateTimeField(auto_now_add=True)  # Field name made lowercase.
    modifiedby = models.ForeignKey(Customers, related_name='useracc_modified_by', on_delete=models.SET_NULL, blank=True,null=True)  # Field name made lowercase.
    modifiedon = models.DateTimeField(auto_now=True)  # Field name made lowercase.
    isdeleted = models.BooleanField(default=False)  # Field name made lowercase.
    ...
    logintrycount = models.SmallIntegerField(default=0)  # Field name made lowercase.
    ...
    added_by = models.ForeignKey(Customers, related_name='useracc_added_by', on_delete=models.SET_NULL, blank=True,null=True)
    ...
    account_locked_for = models.DateTimeField(blank=True, null=True)
    transaction_locked_for = models.DateTimeField(blank=True, null=True)
    transaction_try_count = models.SmallIntegerField(default=0)
    image = models.ImageField(upload_to='DisplayPicture/', blank=True, null=True)
    ...
    def save(self, *args, **kwargs):
        ...
        if not self.fullname:
            ...
            if self.middlename:
                fullname +=f"{self.middlename} "
            if self.lastname:
                fullname +=f"{self.lastname}"
...
class Activationlinks(models.Model):
    ...
    createdby = models.ForeignKey(User, related_name='ac_link_created_by', on_delete=models.CASCADE, blank=True,
                                  null=True)  # Field name made lowercase.
    createdon = models.DateTimeField(auto_now_add=True)  # Field name made lowercase.
    modifiedby = models.ForeignKey(User, related_name='ac_link_modified_by', on_delete=models.CASCADE, blank=True,
                                   null=True)  # Field name made lowercase.
    modifiedon = models.DateTimeField(auto_now=True)  # Field name made lowercase.
    isdeleted = models.BooleanField(default=False)  # Field name made lowercase.
    ...
    def __str__(self):
        return f"{self.activationcode}-{self.createdby}"
...
class Activitylog(models.Model):
    ...
    def __str__(self):
        return f"{self.user.email}-{self.activitytime.strftime('%d/%m/%Y %H:%M')}"
...
class Currencyconversionmargins(models.Model):
    ...
    marginpercent = models.CharField(max_length=20)
    isdeleted = models.BooleanField(default=False)
    createdon = models.DateTimeField(auto_now_add=True)
...
class Externalbeneficiaries(models.Model):
    ...
    account_type = models.CharField(max_length=50, choices=ACCOUNTTYPE, default='Personal')
    slug = models.SlugField(unique=True)
...
class TemporaryCred(models.Model):
    useraccount = models.ForeignKey(Useraccounts,related_name='temporarycred_useraccount',blank=True, null=True, on_delete=models.CASCADE)
    email = models.CharField(max_length=100, blank=True, null=True)
...
class WalletWithdrawalTransactions(models.Model):
    ...
    createdby = models.ForeignKey(User, related_name='walletwithdrawal_createdby', on_delete=models.SET_NULL,
                                  blank=True, null=True)
    createdon = models.DateTimeField(auto_now_add=True)
    modifiedby = models.ForeignKey(User, related_name='walletwithdrawal_modifiedby', on_delete=models.SET_NULL,
                                   blank=True, null=True)
    modifiedon = models.DateTimeField(auto_now=True)
    isdeleted = models.BooleanField(default=False)
    verificationstatus = models.CharField(max_length=30, choices=VERIFICATION_STATUSES, default="Pending", blank=True,
                                          null=True)
    approvallevel = models.SmallIntegerField(blank=True, null=True)
    admincomments = models.ManyToManyField('Comments')
    hideforadmin = models.BooleanField(default=False)
...
class Cryptobeneficiaries(models.Model):
    ...
    name = models.CharField(max_length=200)
    wallet_name = models.CharField(max_length=200)
    currency = models.ForeignKey(Currencies, related_name='crypto_ben_crncy', on_delete=models.SET_NULL, blank=True,
                                 null=True)
    createdby = models.ForeignKey(User, related_name='crypto_ben_created_by', on_delete=models.SET_NULL, blank=True,
                                  null=True)
    createdon = models.DateTimeField(auto_now_add=True)
    modifiedby = models.ForeignKey(User, related_name='crypto_ben_modified_by', on_delete=models.SET_NULL, blank=True,
                                   null=True)
    modifiedon = models.DateTimeField(auto_now=True)
    isdeleted = models.BooleanField(default=False)
...
class WalletWithdrawalRefundRequests(models.Model):
    amount = models.DecimalField(max_digits=18, decimal_places=4)
    requestedby = models.ForeignKey(AdminAccount, related_name='wallet_tr_refund_requestedby',
                                    on_delete=models.SET_NULL, blank=True, null=True)
    isapproved = models.BooleanField(default=False)
    approvedby = models.ForeignKey(AdminAccount, related_name='wallet_tr_refund_approvedby', on_delete=models.SET_NULL,
                                   blank=True, null=True)
    comment = models.CharField(max_length=4000, blank=True, null=True)
    wallet_withdrawal_transaction = models.ForeignKey(WalletWithdrawalTransactions,
                                                      related_name='wallet_tr_refund_transaction',
                                                      on_delete=models.CASCADE)
    isdeleted = models.BooleanField(default=False)
    objects = models.Manager()
    active = GetActiveManager()
...
class APIaccessToken(models.Model):
    ...
    user = models.ForeignKey(User, related_name='apitoken_user', on_delete=models.SET_NULL, blank=True,
                             null=True)
    createdon = models.DateTimeField(auto_now_add=True)
...
class Stripe_Customer(models.Model):
    ...
    customer_id = models.CharField(max_length=1000,blank=True, null=True)
    token_id = models.CharField(max_length=1000,blank=True, null=True)
    city =  models.CharField(max_length=200,blank=True, null=True)
...
class Stripe_Transaction(models.Model):
    ...
    customer = models.ForeignKey(Stripe_Customer,related_name='stripe_customer_details', on_delete=models.CASCADE,blank=True, null=True)
