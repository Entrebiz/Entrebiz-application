...
# DRF
REST_FRAMEWORK = {
    'EXCEPTION_HANDLER': 'api.v1.utils.custom_exception_handler.custom_exception_handler',
...
STATICFILES_DIRS = [
    os.path.join(SUB_BASE_DIR, 'static')
]
# STATIC_ROOT = '/static/'
STATIC_ROOT = os.path.join(SUB_BASE_DIR,'staticfiles')
MEDIA_URL = '/'
MEDIA_ROOT = os.path.join(SUB_BASE_DIR, 'media')
