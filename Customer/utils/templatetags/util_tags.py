...
from utils.models import Accounts, Activitylog, Businessdetails, Useraccounts, Customerdocumentdetails, Customerdocumentfiles, \
...
def enable_view_action(transaction,request):
    ...
    if transaction_type in ["International Transfer", "Acccount To Account Transfer","Currency Conversion","Wallet Withdrawal Transfer", "Domestic Transfer"]:
        return True
    elif flag and transaction_type in ["Acccount To Account Transfer Fee","Currency Conversion Fee","International Transfer Fee","Wallet Withdrawal Transfer Fee", "Domestic Transfer Fee"]:
        return True
    else:
        return False
