...
from utils.models import (Accounts, Customers, Inwardremittancetransactions, Useraccounts,Internalbeneficiaries,Currencies,
         ...
         Cablecharges, Conversioncharges, Conversionfeecharges, Currencyconversionmargins,Referralfeetransactiondetails,
         Currencyconversionrates, Currencyconversionratescombined, Documenttypes, Documentfields,
         Documenttypesforverification, Customerdocuments, Customerdocumentfiles,Comments,Referrerdetails,WalletWithdrawalRefundRequests,
         Customerdocumentdetails,  Internationaltransactions ,Otps, Receivemoney,AdminAccount,Incomingtracepayment,CurrencyConversionAPI,
         Supportqueries, Transactionauthoritytypes, Transactionpurposetype, Userapikey, InvoiceDocument,Businesstransactionauthorities,RefundRequests,Inwardremittancetransactions, DomesticTransaction)
from django.contrib.admin.models import LogEntry

admin.site.register(Accounts)
admin.site.register(WalletWithdrawalRefundRequests)
